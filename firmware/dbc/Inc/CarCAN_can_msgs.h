...
typedef enum {
    ...
    PDU_STATUS_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 13,
    ...
    PDU_STATUS_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 7,
...
typedef enum {
    ...
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 14,
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 13,
    ...
    PDU_SET_SWITCH_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 7,
...
typedef enum {
    ...
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 14,
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 13,
    ...
    PDU_SET_CURRENT_LIMIT_ARR_HSS_CHANNEL_IDX_UNASSIGNED = 7,
